...
##WOE variabili di profilo

dovrò scrivere una funzione per calcolare l'information value.


```{r}

woe(Data=bank0,"job",FALSE,"y",10,Bad=0,Good=1)

iv.mult(bank0,"y",vars=c("housing"))
...
housing_woe$woe <- log(housing_woe$perc_no / housing_woe$perc_y) # ok WOE

#IV = sum((perc_no - perc_y) * housing_woe$woe

sum((housing_woe$perc_no - housing_woe$perc_y) * housing_woe$woe) # corretto
